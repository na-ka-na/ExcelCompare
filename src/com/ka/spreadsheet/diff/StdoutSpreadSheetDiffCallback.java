...
public class StdoutSpreadSheetDiffCallback implements SpreadSheetDiffCallback {
    ...
    public void reportExtraCell(boolean inFirstSpreadSheet, CellPos c) {
        ...
        System.out.println("EXTRA Cell in " + wb(inFirstSpreadSheet) + " " + c.getCellPosition() +" => '" + c.getStringValue() + "'");
    }
    ...
    private void reportSummary(String what, Set<Object> sheets, Set<Object> rows, Set<Object> cols, Set<Object> macros) {
